...
def plot_set(x_range,y_range,contours,sites,grid,pointsize):
    N = 100
...
def plot_edges(x_range,y_range,contours,sites,avg_edgecount,grid,pointsize):
    N = 100
    x_vec = np.linspace(x_range[0], x_range[1], N)
    y_vec = np.linspace(y_range[0], y_range[1], N)
    energy = np.zeros((N, N))
...
def plot_set_cross(x_range,y_range,contours,basin_A_sites,set_sites,first_crosses,grid,pointsize):
    N = 100
    x_vec = np.linspace(x_range[0], x_range[1], N)
    y_vec = np.linspace(y_range[0], y_range[1], N)
    energy = np.zeros((N, N))
